...
public class MyDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        String SanPham = "CREATE TABLE SanPham ( MaSanPham INTEGER PRIMARY KEY AUTOINCREMENT, MaLoai INTEGER REFERENCES TheLoai (MaLoai), TenSanPham TEXT (50) NOT NULL, Gia INTEGER NOT NULL CHECK (gia >= 0), SoLuong INTEGER NOT NULL CHECK (SoLuong >= 0), MoTa TEXT (150),uriHinh TEXT (150));";

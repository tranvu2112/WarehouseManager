...
public class HomeFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btnAccount.setOnClickListener(view1 -> {
            accountOnClick();
        });
        btnProduct.setOnClickListener(view1 -> {
            replaceFragment(new ProductFragment(),R.id.product);
        });
        ...
        btnInvoice.setOnClickListener(view1 -> {
            replaceFragment(new InvoiceFragment(),R.id.bill);
        });
        btnStatiscal.setOnClickListener(v -> {
            replaceFragment(new StatiscalFragment(),R.id.status);
        });
    }
